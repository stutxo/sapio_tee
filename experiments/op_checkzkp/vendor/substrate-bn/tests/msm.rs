...
fn interleaved_msm_matches_binary_multiplication_at_boundaries() {
    let g = G1::one();
    let points = [g, -g, g * scalar(2), g * scalar(3), g * scalar(5), g * scalar(7)];
    let values = [1u128 << 127, u128::MAX, (1u128 << 64) + 1, (1u128 << 32) - 1, 0, 13];
...
fn interleaved_msm_accepts_infinity_from_subset_cancellation() {
    ...
    let doubled = g + g;
    let terms = [
        (g, u128::MAX), (-g, u128::MAX),
        (doubled, 1u128 << 127), (-doubled, 1u128 << 127),
        (G1::zero(), 19), (g, 0),
    ];
